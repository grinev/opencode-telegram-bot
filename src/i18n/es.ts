...
export const es: I18nDictionary = {
  ...
  "prompt_queue.queued": "⏳ En cola (#{position}) — se ejecutará cuando el agente esté libre.",
  "prompt_queue.running": "▶️ Ejecutando este mensaje en cola.",
  "prompt_queue.cancelled": "🚫 Mensaje en cola cancelado.",
  "prompt_queue.cancel_too_late": "Ya se inició, es tarde para cancelar.",
  "prompt_queue.dropped": "🚫 Mensaje descartado: la sesión cambió.",
  "prompt_queue.cleared": "🚫 Se descartaron {count} mensaje(s) en cola.",
  "cmd.description.unqueue": "Eliminar el último mensaje en cola",
  "unqueue.empty": "📭 No hay mensajes en cola para eliminar.",
  "unqueue.removed": "↩️ Se eliminó el último mensaje en cola (quedan {remaining}):\n{preview}",
  "prompt_queue.failed": "🔴 No se pudo ejecutar el mensaje en cola.",
  "prompt_queue.full": "⏳ La cola está llena ({limit}). Espera al agente o usa /abort.",
