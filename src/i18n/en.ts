export const en = {
  ...
  "progress.compact.finished_header": "✅ Response complete",
  ...
  "queue.added": "📥 Forwarding to OpenCode's queue.",
  "queue.full":
    "⚠️ The pending submission queue is full ({max}). Remove a message or try again shortly.",
