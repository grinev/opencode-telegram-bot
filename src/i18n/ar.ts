...
export const ar: I18nDictionary = {
  ...
  "progress.compact.finished_header": "✅ اكتمل الرد",
  ...
  "queue.added": "📥 جارٍ الإرسال إلى قائمة انتظار OpenCode.",
  "queue.full": "⚠️ قائمة الإرسال المعلّق ممتلئة ({max}). احذف رسالة أو حاول مرة أخرى بعد قليل.",
