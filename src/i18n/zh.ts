...
export const zh: I18nDictionary = {
  ...
  "ls.file.download": "📥 下载",
  "ls.file.back": "⬅️ 返回",
  "prompt_queue.queued": "⏳ 已排队（第 {position} 条）——代理空闲后自动执行。",
  "prompt_queue.running": "▶️ 正在执行这条排队消息。",
  "prompt_queue.cancelled": "🚫 已取消排队消息。",
  "prompt_queue.cancel_too_late": "已经开始执行，无法取消。",
  "prompt_queue.dropped": "🚫 会话已变更，排队消息已丢弃。",
  "prompt_queue.cleared": "🚫 已清空 {count} 条排队消息。",
  "cmd.description.unqueue": "撤销最新一条排队消息",
  "unqueue.empty": "📭 没有排队消息可撤销。",
  "unqueue.removed": "↩️ 已撤销最新一条排队消息（剩 {remaining} 条）：\n{preview}",
  "prompt_queue.failed": "🔴 排队消息执行失败。",
  "prompt_queue.full": "⏳ 队列已满（{limit} 条）。请等待代理完成，或使用 /abort。",
  "prompt_queue.button.cancel": "❌ 取消",
};
