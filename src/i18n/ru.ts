...
export const ru: I18nDictionary = {
  ...
  "progress.compact.finished_header": "✅ Ответ завершён",
  ...
  "queue.added": "📥 Отправляется в очередь OpenCode.",
  "queue.full": "⚠️ Очередь ожидающих отправок заполнена ({max}). Удалите сообщение или повторите попытку чуть позже.",
