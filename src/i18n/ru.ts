...
export const ru: I18nDictionary = {
  ...
  "bot.media_error": "🔴 Не удалось обработать медиафайл.",
  "bot.voice_transcribing": "🎤 Транскрибирую...",
  "bot.voice_not_configured":
    "🎤 Голосовое сообщение получено: `{filePath}`\n\nℹ️ Настрой `TRANSCRIBE_VOICE_COMMAND` в `{envPath}`, чтобы включить автотранскрипцию.\n[Как настроить голосовую транскрипцию](https://github.com/grinev/opencode-telegram-bot#voice-transcription)",
  "bot.voice_transcription_failed":
    "🎤 Голосовое сообщение получено: `{filePath}`\n\n🔴 Бот попытался автоматически транскрибировать голосовое сообщение, но `TRANSCRIBE_VOICE_COMMAND` завершился с ошибкой. Проверь `{envPath}`\n\n```\n{details}\n```",
