...
export const it: I18nDictionary = {
  ...
  "progress.compact.finished_header": "✅ Risposta completata",
  ...
  "queue.added": "📥 Invio alla coda di OpenCode.",
  "queue.full": "⚠️ La coda degli invii in sospeso è piena ({max}). Rimuovi un messaggio o riprova tra poco.",
