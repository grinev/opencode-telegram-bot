...
export const pt: I18nDictionary = {
  ...
  "prompt_queue.queued": "⏳ Na fila (#{position}) — será executada quando o agente estiver livre.",
  "prompt_queue.running": "▶️ Executando esta mensagem da fila agora.",
  "prompt_queue.cancelled": "🚫 Mensagem da fila cancelada.",
  "prompt_queue.cancel_too_late": "Já começou — tarde demais para cancelar.",
  "prompt_queue.dropped": "🚫 Mensagem da fila descartada: a sessão mudou.",
  "prompt_queue.cleared": "🚫 {count} mensagem(ns) da fila descartada(s).",
  "cmd.description.unqueue": "Remover a última mensagem da fila",
  "unqueue.empty": "📭 Nenhuma mensagem na fila para remover.",
  "unqueue.removed": "↩️ Última mensagem da fila removida (restam {remaining}):\n{preview}",
  "prompt_queue.failed": "🔴 Não foi possível executar esta mensagem da fila.",
  "prompt_queue.full": "⏳ A fila está cheia ({limit} mensagens). Aguarde o agente ou use /abort.",
  "prompt_queue.button.cancel": "❌ Cancelar",
};
